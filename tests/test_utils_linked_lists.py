...
class TestlinkedList(unittest.TestCase):
    ...
    def test_add_value(self):
        """
        test interview.utils.linked_lists :: LinkedList :: add_value
        """
        tests = [
            {
                "list": [1, 2, 3, 4, 5],
        ...
        for test in tests:
            self.example_linked_list._construct_from_list(test.get('list'))
            args = {
                "position": test.get('position'),
                "value": test.get('value'),
            }
            expected = test.get('returned')
            self.example_linked_list.add_value(**args)
            returned = self.example_linked_list.stringify_list()
            self.assertEqual(expected, returned)

    def test_add_value_to_head(self):
        """
        test interview.utils.linked_lists :: LinkedList :: add_value_to_head
        """
        expected = self.example_stringified_list
        self.example_linked_list.add_value_to_head(self.example_value_2)
        returned = self.example_linked_list.stringify_list()
        self.assertEqual(expected, returned)

        # when there is no head node
        expected = self.example_value_1 + '\n'
        self.example_empty_list.add_value_to_head(self.example_value_1)
        returned = self.example_empty_list.stringify_list()
        self.assertEqual(expected, returned)

    def test_add_value_to_the_end(self):
        """
        test interview.utils.linked_lists :: LinkedList :: add_value_to_the_end
        """
    ...
    def test_construct_from_list(self):
        """
        test interview.utils.linked_lists :: LinkedList :: _construct_from_list
        """
    ...
    def test_get_head_node(self):
        """
        test interview.utils.linked_lists :: LinkedList :: get_head_node
        """
        expected = self.example_value_1
    ...
    def test_insert_beginning(self):
        """
        test interview.utils.linked_lists :: LinkedList :: insert_beginning
        """
    ...
    def test_remove_first_node_by_value(self):
        """
        test interview.utils.linked_lists :: LinkedList :: remove_first_node_by_value
        """
    ...
    def test_stringify_list(self):
        """
        test interview.utils.linked_lists :: LinkedList :: stringify_list
        """
        expected = self.example_stringified_list
        self.example_linked_list.insert_beginning(self.example_value_2)
        returned = self.example_linked_list.stringify_list()
